...
class User(override val name: String, override val image: String, var level: Int,  var missingExperience: Double, var allCards: List[Card], var healthPoint: Int, var coins: Int) extends Player {
