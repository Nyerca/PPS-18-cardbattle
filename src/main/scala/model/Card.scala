...
object Card {
  def apply(name: String, image: String, family: (Category,Type), level: Int = 1, value: Int = 3, cardMissingForNextLevel: Int = 1): Card = CardImpl(name, image, level, family, value, cardMissingForNextLevel)
}
